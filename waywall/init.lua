...
local cfg = {
    ...
    -- ==== MACROS ====
    -- resolution changes
    thin = { key = "*-F4", f3_safe = false, ingame_only = true },
    ...
    -- ==== MISC ====
    sens_change = { enabled = true, normal = 25.0, tall = 0.1 }, -- make sure raw input is off
